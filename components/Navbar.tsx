import { FilmIcon, MagnifyingGlassCircleIcon } from "@heroicons/react/outline";
    ...
    <div>
      <div className="navbar__pc">
        <Image
          ...
          className="ml-28"
        />
        <div className="flex justify-between items-center w-10/12 h-16 bg-blue-700 m-auto rounded-xl">
